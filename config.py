...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "7755224042:AAGItHggaJT9q_ijJxbPtqgrV39e7Hr5A5o")
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1001827427870"))
...
try:
    ADMINS=[1110013191]
    for x in (os.environ.get("ADMINS", "1110013191 6618620897 6663845789").split()):
        ADMINS.append(int(x))
except ValueError:
